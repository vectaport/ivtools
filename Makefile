...
# from <local.def>:
     ...
     GPLUSPLUS_INCLUDE_DIR = /usr/include/gcc/darwin/2.95.2/g++/
          TOOL_INCLUDE_DIR =
    ...
    APP_CCINCLUDES = $(NORM_CCINCLUDES)
             ...
             IVTOOLSSRC = /Users/scott/src/ivtools-1.0/src
     ...
     DEPEND_CCFLAGS = -w -DMAKEDEPEND $(CCDEFINES) $(CCINCLUDES) -I$(GPLUSPLUS_INCLUDE_DIR) -I$(TOOL_INCLUDE_DIR) -UHAVE_ACE
       ...
       SPECIAL_ARCH =
           ...
           CCSUFFIX = c
            CDRIVER = cc
            CSUFFIX = c
                SRC = /Users/scott/src/ivtools-1.0/.
              SLASH = /
    ...
    RANLIBINSTFLAGS =
             ...
             RM_CMD = $(RM) ,* .emacs_* *..c *.BAK *.CKP *.a *.bak *.ln *.o a.out core errs make.log make.out tags TAGS
              TROFF = groff
                ...
                TOP = /Users/scott/src/ivtools-1.0
             RELTOP = .
        CURRENT_DIR = /Users/scott/src/ivtools-1.0

              IVSRC = /Users/scott/src/ivtools-1.0/src
             BINSRC = $(IVSRC)/bin
