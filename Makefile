...
# from <local.def>:
    ...
    APP_CCINCLUDES = $(NORM_CCINCLUDES)
             ...
             IVTOOLSSRC = /Users/scott/src/c++/ivtools-1.2/src
     ...
     DEPEND_CCFLAGS = -w -DMAKEDEPEND $(CCDEFINES) $(CCINCLUDES) -I$(TOOL_INCLUDE_DIR) -UHAVE_ACE
       ...
       SPECIAL_ARCH =
           ...
           CCSUFFIX = c
            CDRIVER = gcc
            CSUFFIX = c
                SRC = /Users/scott/src/c++/ivtools-1.2/.
              SLASH = /
...
CLIPPOLY_CCINCLUDES =
    ...
    TIFF_CCINCLUDES =
             ...
             ACEDIR = /Users/scott/src/c++/ACE_wrappers

          ACELIBDIR = /Users/scott/src/c++/ACE_wrappers/ace

             CFLAGS = $(APP_CCFLAGS) $(IV_CFLAGS) $(OTHER_CCFLAGS) $(EXTRA_CCFLAGS)
    ...
    RANLIBINSTFLAGS =
             ...
             RM_CMD = $(RM) ,* .emacs_* *..c *.BAK *.CKP *.a *.bak *.ln *.o a.out core errs make.log make.out tags TAGS
              TROFF = groff
                ...
                TOP = /Users/scott/src/c++/ivtools-1.2
             RELTOP = .
        CURRENT_DIR = /Users/scott/src/c++/ivtools-1.2

              IVSRC = /Users/scott/src/c++/ivtools-1.2/src
             BINSRC = $(IVSRC)/bin
