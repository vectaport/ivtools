...
// days:h:m:s; 5 fields auto-detects the same way, a plausible year reading
// as the local-time instant YEAR:MON:day:hr:min and anything else as the
// duration yrs:days:h:m:s; 7-to-10 is always the
