...
#define UNEXPECTED_RPAREN_ERROR( paren_type ){\
int errid;\
...
#define UNEXPECTED_LPAREN_ERROR( paren_type ){\
int errid;\
...
static int get_next_token(
   ...
   buffer, bufsiz, bufptr, token, toksiz, toklen, toktype,
   tokstart, linenum, op_ids, nop_ids )
...
int parser( infile, infunc, eoffunc, errfunc, outfile, outfunc,
	    buffer, bufsiz, bufptr, token, toksiz, linenum,
	    pfbuf, pfsiz, pfnum )
