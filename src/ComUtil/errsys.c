...

{
	...
	KAPUT1( "Exceeded maximum number of opened error files", 
		MAX_ERROR_OPENS );
...
void err_set( errid, errnum, errlen )
...
void err_print( outstream, command )
...
void err_str( errbuf, bufsiz, command )
