...
4. Download ivtools-0.8.tgz or later:

http://www.vectaport.com/pub/src/ivtools-0.8.tgz

In a cygwin/bash window:

	tar xvfz ivtools-0.8.tgz  	# unpack and move to top directory
        cd ivtools-0.8
...
ivtools:
	...
	ivtools-0.8/src/comterp_/CYGWIN/a.out
